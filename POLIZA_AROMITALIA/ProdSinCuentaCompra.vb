...
Public Class ProdSinCuentaCompra
    Public Shared Sub EnviarProdSCC()
        Using cn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("COI").ToString)
            Dim ada As New SqlDataAdapter("SELECT * FROM  CORREOS_INSOFTEC WHERE TIPO='Compras'", cn)
...
" <p align='center' style='font-family:Calibri Light; font-size:20px'>[-Error de Generaci&oacute;n de P&oacute;liza-] <br><br>/ Compra: " + CVE_DOC + " / Fecha: " & FECHA_DOC & " <br><br>Producto: (" & CVE_ART & " ) " & MIDESCR & " <br><br>&rarr; Favor de validar o capturar la cuenta contable del producto indicado, en el campo CUENTA COMPRAS en la ficha de Datos Adicionales.<br><br>Gracias.<br><br></p>" &
