...
Public Class CorreoSinCuentaContable
    Public Shared Sub EnviarCorreoSinCuenta()

        Using cn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("COI").ToString)
            Dim adapter As New SqlDataAdapter("SELECT * FROM CORREOS_INSOFTEC WHERE TIPO='Ventas'", cn)
...
" <p align='center' style='font-family:Calibri Light; font-size:20px'>[-Error de Generaci&oacute;n de P&oacute;liza-] <br><br>/ Factura: " + CVE_DOC + " / Fecha: " & FECHA_DOC & " <br><br>Cliente: (" & CVE_CLPV & " ) " & NOMBRE_CLIENTE & " <br><br>&rarr; Favor de revisar la cuenta capturada en SAE, es posible que est&eacute; vac&iacute;a o no existe en COI: " & CUENTA_CONTABLE & " <br><br>Gracias.<br><br></p>" &
