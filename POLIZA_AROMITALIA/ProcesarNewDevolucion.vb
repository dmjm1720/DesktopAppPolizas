...
Public Class ProcesarNewDevolucion
    ...
    Public Shared Sub NewDevolucion()
        ...
        Using ConFactD As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("SAE").ToString)
            ...
            Do While (j <= i)
                ...
                Using ConAux2 As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("COI").ToString)
                    ...
                    Dim cmdAux2 As New SqlCommand(("INSERT INTO " & AUXILIAR & " (TIPO_POLI, NUM_POLIZ, NUM_PART, PERIODO, EJERCICIO, NUM_CTA, FECHA_POL, CONCEP_PO, DEBE_HABER, MONTOMOV, NUMDEPTO,TIPCAMBIO,CONTRAPAR,ORDEN, CCOSTOS,CGRUPOS) VALUES ('" & TIPOFACTD & "',RIGHT('     ' + LTRIM(RTRIM(" & contador & ")), 5),'" & Q1 + 1 & "','" & PERIODO & "','" & EJERCICIO & "','" & CUENTA_CONTABLE + "000000000003" & "','" & FECH & "','" + "DEVOLUCIÓN " & CVE_DOC + "    " + CONCEPTO + " " & "','H','" & Math.Round(IMPORTE, 2) & "','" & DEPTO & "','" & TIPCAMB & "','0','" & Q1 + 1 & "','0','0');"), ConAux2)
                ...
                Using INSERT_PARTIDAS As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("COI").ToString)
                    If IMP_TOT4 > 0 Then
                        ...
                        Dim commandD As New SqlCommand(("INSERT INTO " & AUXILIAR & " (TIPO_POLI, NUM_POLIZ, NUM_PART, PERIODO, EJERCICIO, NUM_CTA, FECHA_POL, CONCEP_PO, DEBE_HABER, MONTOMOV, NUMDEPTO,TIPCAMBIO,CONTRAPAR,ORDEN, CCOSTOS,CGRUPOS) VALUES ('" & TIPOFACTD & "',RIGHT('     ' + LTRIM(RTRIM(" & contador & ")), 5),' " & Q2 + 1 & " ','" & PERIODO & "','" & EJERCICIO & "','" & DEF1 & "','" & FECH & "','" + "DEVOLUCIÓN " & CVE_DOC & "','D','" & Math.Round(IMP_TOT4, 2) & "','0','" & TIPCAMB & "','0','" & Q2 + 1 & "','0','0');"), INSERT_PARTIDAS) 'DEF1                    
