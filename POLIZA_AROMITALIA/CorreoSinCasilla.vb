...
Public Class CorreoSinCasilla
    Public Shared Sub CapturaXMLCasilla()
...
"<center><table width='985' border='0' align='left'><tr>" + "<br>" &
 " <p align='center' style='font-family:Calibri Light; font-size:20px'>[-Falta Par&aacute;metro en COI-] <br><br>P&oacute;liza genereda: Ve" & contador & "/ Factura: " + CVE_DOC + " / Fecha: " & FECHA_DOC & " <br><br>Cliente: (" & CVE_CLPV & " ) " & NOMBRE_CLIENTE & " <br><br>&rarr; Favor de activar la casilla de &quot;Captura de comprobantes&quot; en COI para la Cuenta: " & CUENTA_CONTABLE & " <br><br>Gracias.<br><br></p>" &
