...
Public Class CorreoProducto
    Public Shared Sub ProductoSinCuenta()
        Using cn As SqlConnection = New SqlConnection(ConfigurationManager.ConnectionStrings.Item("COI").ToString)
            Dim ada As New SqlDataAdapter("SELECT * FROM  CORREOS_INSOFTEC WHERE TIPO='Ventas'", cn)
...
" <p align='center' style='font-family:Calibri Light; font-size:20px'>[-Error de Generaci&oacute;n de P&oacute;liza-] <br><br>/ Factura: " + CVE_DOC + " / Fecha: " & FECHA_DOC & " <br><br>Producto: (" & CVE_ART & " ) " & MIDESCR & " <br><br>&rarr; Favor de capturar cuenta contable del producto indicado.<br><br>Gracias.<br><br></p>" &
"<th width='979' align='center' bgcolor='#E0F8E6' scope='col' style='font-family:Calibri ligth; font-size:12px, Calibri Ligth; color:#000000'><p></p>" &
 ...
 "<p></p>" &
 "<p>&nbsp;</p>" &
 " <p align='center' style='font-size:30px'> <pre><i>GRUPO COMERCIAL TRIA S.A. DE C.V.---NATURAL.IT MESSICO S.A. DE C.V.</i></pre> </p><br>" &
"</p></th>" &
"</tr></table>" &
